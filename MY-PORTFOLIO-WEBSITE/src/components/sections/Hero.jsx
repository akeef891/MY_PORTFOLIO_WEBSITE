...
import { ease, heroItem, heroStagger, hoverLift, hoverLiftTransition } from "../../lib/motion";
      ...
      <motion.div className="section-container relative z-10 w-full">
        <div className="grid items-end gap-8 sm:gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:gap-14 xl:gap-20">
          ...
          >
            ...
            <motion.p variants={heroItem} className="hero-intro body-muted mt-4 max-w-[48ch] sm:mt-5">
              {personal.intro}
            </motion.p>
